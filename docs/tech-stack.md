...
| Audio source           | everyayah.com                       | Free public CDN with per-ayah recitations; default reciter Mishary Alafasy 128 kbps.            | Self-hosted audio                       | [ADR-0001](adr/0001-tech-stack.md)                |
